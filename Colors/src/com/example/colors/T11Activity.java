...
public class T11Activity extends Activity {
	 int sumaresultado;
        ...
        boton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==findViewById(R.id.button1).getId())
		     	{Intent i = new Intent(T11Activity.this, T12Activity.class);
		         //Inicia la actividad
		     	 sumaresultado +=1;
		     	i.putExtra("variable_integer", sumaresultado);
		         startActivity(i);
		         T11Activity.this.finish();}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.t11, menu);
		return true;
	}
