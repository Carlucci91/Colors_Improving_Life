...
public class T28Activity extends Activity {
	 int sumaresultado;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_t28);
        ...
        boton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==findViewById(R.id.button1).getId())
		     	{Intent i = new Intent(T28Activity.this, T29Activity.class);
		         //Inicia la actividad
		     	i.putExtra("variable_integer", sumaresultado);
		         startActivity(i);
		         T28Activity.this.finish();}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.t28, menu);
		return true;
	}
