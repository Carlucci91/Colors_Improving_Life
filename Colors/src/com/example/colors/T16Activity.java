...
public class T16Activity extends Activity {
	 int sumaresultado;
        ...
        boton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==findViewById(R.id.button1).getId())
		     	{Intent i = new Intent(T16Activity.this, T17Activity.class);
		         //Inicia la actividad
		     	i.putExtra("variable_integer", sumaresultado);
		         startActivity(i);
		         T16Activity.this.finish();}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.t16, menu);
		return true;
	}
