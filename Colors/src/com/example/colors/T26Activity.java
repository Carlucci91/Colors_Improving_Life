...
public class T26Activity extends Activity {
	 int sumaresultado;
        ...
        boton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==findViewById(R.id.button1).getId())
		     	{Intent i = new Intent(T26Activity.this, T27Activity.class);
		         //Inicia la actividad
		     	i.putExtra("variable_integer", sumaresultado);
		         startActivity(i);
		         T26Activity.this.finish();}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.t26, menu);
		return true;
	}
