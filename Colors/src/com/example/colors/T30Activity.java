...
public class T30Activity extends Activity {
	 int sumaresultado;
        ...
        boton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==findViewById(R.id.button1).getId())
		     	{Intent i = new Intent(T30Activity.this, T31Activity.class);
		         //Inicia la actividad
		     	 sumaresultado +=1;
		     	i.putExtra("variable_integer", sumaresultado);
		         startActivity(i);
		         T30Activity.this.finish();}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.t30, menu);
		return true;
	}
